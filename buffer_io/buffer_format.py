...
以下内容99%来自于ShaderFreedom的Discord成员@Aiden.(aidendzw)的分享，并经过部分修改以适应我们的需求。
'''
...
# TODO 这个要修改为我们的NORMAL，TANGENT读取，或者说这个要专门拆分两个类型，一种是先TANGENT再NORMAL，另一种是先NORMAL再TANGENT
...
# TODO 这里可不可以优化为一个类来装这些数据？包括上面的所有的过程全部都在类中进行操作，这样不就极大地提高了代码可读性。
